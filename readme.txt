index.html - basic front page
add_car.html - form to add cars in db
insert_car.php - gets the data through ajax from add_car.html and makes SQL queries
prices.html - shows the prices for rent
rent.php - form where you make a reservation
